...
<tr><th>カテゴリー</th><td><input type="text" name="category" maxlength="10" size="10" />&nbsp;&nbsp;&nbsp;&nbsp;
       <select><option>期間指定</option></select></td></tr>
<tr><th>登録日時</th><td><input type="text" name="created_at" maxlength="10" size="20" />&nbsp;&nbsp;&nbsp;&nbsp;
		 <select><option>期間指定</option></select></td></tr>
<tr><th>登録者</th><td><input type="text" name="created_at" maxlength="10" size="20" /></td></tr>
<tr><th>コメント</th><td><textarea name="messages" cols="70" rows="20" /></textarea></td></tr>
